...
coverage run -a -m simg ./tests/datas/ --mode averageHash --flip-v --flip-h --recurse | grep "./tests/datas/2/imageWhiteCircle1fvfh.png;60;60;60;6;56;28;60;0;0;56;0;4;0;"
coverage run -a -m qsimg ./tests/datas/ "./tests/datas/2/imageWhiteCircle1fvfh.png" --mode pHash --flip-v --flip-h --recurse | { tr '\n' ';' ; echo; } | grep "./tests/datas/imageWhiteCircle1fv.png;./tests/datas/imageWhiteCircle1fh.png;./tests/datas/imageWhiteCircle1.png;./tests/datas/2/imageWhiteCircle1fvfh.png;./tests/datas/imageWhiteCircle2.png;./tests/datas/imageBlackRectangle1.png;./tests/datas/imageWhite.png;./tests/datas/empty.png;./tests/datas/imageRedBlue.png;./tests/datas/imageBlack.png;./tests/datas/imageBlackRectangle2.png;./tests/datas/imageWhiteCircle3.png;./tests/datas/imageBlackCircle1.png;"
coverage run -a -m qsimg ./tests/datas/ --rand --seed 42 --mode pHash --flip-v --flip-h --recurse --verbose | { tr '\n' ';' ; echo; } | grep "./tests/datas/imageWhiteCircle1fv.png;0;;./tests/datas/imageWhiteCircle1fh.png;0;;./tests/datas/imageWhiteCircle1.png;0;;./tests/datas/2/imageWhiteCircle1fvfh.png;0;;./tests/datas/imageWhiteCircle2.png;19;;./tests/datas/imageBlackRectangle1.png;27;;./tests/datas/imageWhite.png;27;;./tests/datas/empty.png;27;;./tests/datas/imageRedBlue.png;27;;./tests/datas/imageBlack.png;27;;./tests/datas/imageBlackRectangle2.png;27;;./tests/datas/imageWhiteCircle3.png;28;;./tests/datas/imageBlackCircle1.png;28;;"
